...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(cohort => cohort.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(cohort => cohort.FullTime == true && cohort.PrimaryInstructor.Birthday > DateTime.Now);
        ...
        {
            var shouldThrowException = PracticeData.Single(cohort => cohort.FullTime == false && cohort.Active == false);
        }
