...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(cohorts => cohorts.FullTime == true).ToList();
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(cohorts => cohorts.PrimaryInstructor == CohortBuilder.Instructor2).ToList();
