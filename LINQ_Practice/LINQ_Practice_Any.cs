...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Any
    {
        ...
        {
            var doAny = PracticeData.Any(cohort => cohort.PrimaryInstructor.Birthday.Year == 1989);
        ...
        {
            var doAny = PracticeData[2].Students.Any(students => students.Birthday.Month == 10 && students.Active == false);  //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var doAny = PracticeData[3].JuniorInstructors.Any(instructor => instructor.Active == false);  //HINT: Cohort4 is PracticeData[3]
            Assert.IsFalse(doAny); //<-- change true to doAny
        }
    }
}
