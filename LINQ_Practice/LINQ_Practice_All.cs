...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(cohorts => cohorts.PrimaryInstructor.Active == true);
        ...
        {
            var doAll = PracticeData[0].Students.All(students => students.FirstName.Contains("e")); //Hint: Cohort1 would be PracticeData[0]
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(cohorts => cohorts.Active == true && cohorts.PrimaryInstructor.FirstName.Contains("A"));
